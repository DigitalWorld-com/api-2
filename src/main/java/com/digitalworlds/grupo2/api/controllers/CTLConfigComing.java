...
import com.digitalworlds.grupo2.api.services.IConfigComing;
...
public class CTLConfigComing {
    ...
    public ResponseEntity<DTOConfigComing> getConfigComing(@ApiParam(value = "Ej. AR, ES, US, etc.", example = "AR") @PathVariable String region) {
        ...
        ResponseEntity<DTOConfigComing> response = ResponseEntity.ok(iConfigComing.getConfigComing(region));
    ...
    public ResponseEntity postConfigComing(@RequestBody DTOConfigComing dtoConfigComing) {
        ...
        ResponseEntity<DTOConfigComing> response = new ResponseEntity(iConfigComing.postConfigComing(dtoConfigComing), HttpStatus.CREATED);
    ...
    public ResponseEntity putConfigComing(@RequestBody DTOConfigComing dtoConfigComing) {
        ...
        ResponseEntity<DTOConfigComing> response = ResponseEntity.ok(iConfigComing.putConfigComing(dtoConfigComing));
    ...
    public ResponseEntity deleteGreeting(@PathVariable("region") String region) {
        log.info("<<<<< ---- [PUT]/coming/{region} ---- >>>>>");
        ResponseEntity<DTOConfigComing> response = new ResponseEntity(iConfigComing.deleteConfigComing(region), HttpStatus.NO_CONTENT);
        log.info("<//// ---- [PUT]/coming/{region} ---- ////>[OK]");
        return response;
    }
